 ...
 */
public class DemoTiltBall87509Activity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.i(MYDEBUG, "Got here! (DemoTiltBall87509Activity - onCreate)");
        ...
        rb.configure(pathType, pathWidth, gain, orderOfControl, numOfLaps);
...
//        sM = sm.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD); // null on many devices
    ...
    /*
        Should be called when the laps are finished
     */
    public void finished(int laps, int wallHits, int totalLapTime, int totalPathTime){
        //Pack all the player stats to pass
        Intent intent = new Intent(this, Results.class);
        intent.putExtra("laps", laps);
        intent.putExtra("wallHits", wallHits);
        intent.putExtra("lapTime", totalLapTime);
        intent.putExtra("pathTime", totalPathTime);
