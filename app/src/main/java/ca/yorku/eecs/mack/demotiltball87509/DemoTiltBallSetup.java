...
public class DemoTiltBallSetup extends Activity 
{
	...
	final static int NUM_OF_LAPS = 50;
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		//Set up laps spinner
		spinNumLaps = (Spinner) findViewById(R.id.paramNumOfLaps);
		//Make a string array of nums 1 - 50
		laps = new String[NUM_OF_LAPS];
		for(int i = 1; i <= NUM_OF_LAPS ; i++){
			laps[i-1] = i + "";
		}
		ArrayAdapter<CharSequence> adapter5 = new ArrayAdapter<CharSequence>(this, R.layout.spinnerstyle, laps);
	...
	public void clickOK(View view) 
	{
		...
		int numLaps = spinNumLaps.getSelectedItemPosition() + 1;
		...
		b.putInt("numOfLaps", numLaps);

		// start experiment activity
		Intent i = new Intent(getApplicationContext(), DemoTiltBall87509Activity.class);
		i.putExtras(b);
		startActivity(i);
